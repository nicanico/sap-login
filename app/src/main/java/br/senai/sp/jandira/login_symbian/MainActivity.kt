...
import br.senai.sp.jandira.login_symbian.ui.theme.LoginsymbianTheme
        ...
        Column (
            ...
            FilledIconButton(
                modifier = Modifier
                    .width(325.dp)
                    .height(45.dp),
                onClick = { photoUri?.let { uploadImage(it, context, userEmailState, userPasswordState, lifecycleCoroutineScope) } }
            ) {
                Text("Sign In")
            }
...
private fun uploadImage(imageUri: Uri, context: Context, emailUser: String, password: String, lifecycleCoroutineScope: LifecycleCoroutineScope?) {
                        ...
                        .addOnCompleteListener { firestoreTask ->
                            ...
                            if (firestoreTask.isSuccessful) {
                                ...
                                lifecycleCoroutineScope?.launch {
                                    ...
                                    Log.e("CREATE-DATA", "STATUS: ${emailUser}, ${password}, ${uri.toString()}")
                                    val result = loginRepository.loginUsuario(emailUser, password, uri.toString())

                                    if(firestoreTask.isSuccessful){
                                        // val msg = result.body()?.get("mensagemStatus")
                                        Log.e("CREATE-USER", "STATUS: ")
                                        Toast.makeText(
                                            context,
                                        ...
                                        Log.e("CREATE-CATEGORY", "STATUS: erro ")
                                    }
                                }
